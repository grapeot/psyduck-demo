...
import {motionModel,armBind,applyPose,preset} from '../src/rig.js';
if(motionModel==='shoulder_flap')throw new Error('Historical two-link ablation is not applicable to the current five-bone rig. Use saved versioned evidence.');
